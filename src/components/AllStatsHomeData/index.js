      ...
      <div className="one12345">
        <div className="table_container">
          <ul className="row_container">
            ...
            <>
              <li className="cell_container1 color11">Confirmed</li>
              <li className="cell_container1 color11">Active</li>
              <li className="cell_container1 color11">Recovered</li>
